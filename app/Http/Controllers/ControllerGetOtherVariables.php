...
class ControllerGetOtherVariables extends Common{
	...
	public function __invoke(){
		...
		// parent::prepare_response(['response' => ['phone' => $phone, 'user_myid' => $user_myid, 'email' => $email, 'status' => $status, 'fio' => $fio, 'photo' => $photo, 'manager_fio' => $manager_fio, 'manager_email' => $manager_email, 'manager_id' => $manager_id, 'is_not_enter_verify_code' => $is_not_enter_verify_code, 'max_file_size_for_manager' => $this->config_project['max_file_size_for_manager'], 'max_file_size_photo' => $this->config_project['max_file_size_photo'], 'max_file_size_for_non_standard_addition' => $this->config_project['max_file_size_for_non_standard_addition'], 'delegation_fio' => $delegation_fio, 'delegation_user_myid' => $delegation_user_myid, 'csrf_token' => $csrf_token]], true);
