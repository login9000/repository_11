...
class ControllerDownloadFinishedProducts extends Common{
	...
	public function __invoke(){
		...
		if($file_format == 'pdf'){
			...
			$link = '/user_files/'.$user_myid.'/finished_products/finished_products_'.str_replace(':', '.', $actual_date).'.pdf';
		...
		if($file_format == 'xlsx'){
			...
			$link = '/user_files/'.$user_myid.'/finished_products/finished_products_'.str_replace(':', '.', $actual_date).'.xlsx';
