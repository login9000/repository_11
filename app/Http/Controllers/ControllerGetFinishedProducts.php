...
class ControllerGetFinishedProducts extends Common{
	...
	public function __invoke(){
		...
		list($finished_products, $err) = parent::prepare_result_finished_products($main_counterparty_id, $shipping_warehouse_id, $products, $profile, $thickness, $coating, $color);
		if($err){
